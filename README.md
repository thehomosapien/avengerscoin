...
git clone https://github.com/rishabhopula/avengerscoin.git 
cd avengerscoin
mkdir build
cd build
cmake ..
...
The resulting executables can be found in `AvengersCoin/build/release/src`.
...
- `cd <your_avengerscoin_directory>`
- `mkdir build`
- `cd build`
...
- `MSBuild AvengersCoin.sln /p:Configuration=Release /m`
